/**
 * Mapeo de Cortes de Apelaciones a sus códigos numéricos
 * Extraído de la documentación oficial del Poder Judicial de Chile
 */
export const CORTES_MAP: { [key: string]: string } = {
  'C.A. de Arica': '10',
  'C.A. de Iquique': '11',
...
/**
 * Mapeo de Tribunales a sus códigos numéricos
 * Incluye tribunales de competencia Civil, Laboral, Penal y Cobranza
 * Extraído de la documentación oficial del Poder Judicial de Chile
 */
export const TRIBUNALES_MAP: { [key: string]: string } = {
  // ============================================
  // TRIBUNALES CIVILES
  // ============================================
  ...
  'Jdo. de Letras del Trabajo de Copiapo': '136',
...
/**
 * Mapeo de competencias a sus códigos numéricos
 */
export const COMPETENCIA_MAP: { [key: string]: string } = {
  'Corte Suprema': '1',
